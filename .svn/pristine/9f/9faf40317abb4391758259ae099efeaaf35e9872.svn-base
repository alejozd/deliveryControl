...
const ComprobantePDF = ({ datos, autoGenerate, onPDFGenerated }) => {
  ...
  const generatePDF = () => {
    ...
    html2canvas(input, { scale: 2, useCORS: true }).then((canvas) => {
      ...
      if (onPDFGenerated) {
        ...
        pdf.save("Cotización" + datos.numerocotizacion + ".pdf");
      }
    });
  };
  ...
  const totalBodyTemplate = (product) => {
    return formatCurrency(product.total);
  };

  const quantityBodyTemplate = (product) => {
    return product.cantidad.toFixed(2);
  };
          ...
          <Card style={styles.card}>
            <Toolbar
              ...
              center={
                <div style={{ textAlign: "center" }}>
                  <p>
                    <strong>DISTRIBUIDORA METROCERAMICAS S.A.S.</strong>
                  </p>
                  <p>
                    <strong>830.112.333-1</strong>
                  </p>
                  <p>
                    <strong>AUTOPISTA NORTE 138 83, BOGOTÁ</strong>
                  </p>
                  <p>
                    <strong>PBX 601 6192221</strong>
                  </p>
                </div>
              }
              end={
            ...
            <div style={styles.clientInfo}>
              <div style={styles.leftColumn}>
                ...
                <p style={styles.p}>
                  <strong>NIT:</strong> {cliente.identidad}
                </p>
                <p style={styles.p}>
              ...
              <div style={styles.rightColumn}>
                <p style={styles.p}>
                  <strong>TELÉFONO:</strong> {cliente.telmovil}
                </p>
                <p style={styles.p}>
...
const styles = {
  ...
  continerCards: {
    border: "1px solid ", // Borde de las tarjetas
    padding: "10px",
  },
  comprobante: {
    marginBottom: "10px",
